...
# Function to reset the ball position after a goal
...
def main_menu():
    ...
    backgroundd1 = pygame.image.load('background1.png')
    background1 = pygame.transform.scale(backgroundd1, (WIDTH, HEIGHT))
    backgroundd2 = pygame.image.load('background2.png')
    background2 = pygame.transform.scale(backgroundd2, (WIDTH, HEIGHT))
    backgroundd3 = pygame.image.load('background3.png')
    background3 = pygame.transform.scale(backgroundd3, (WIDTH, HEIGHT))
    backgroundd4 = pygame.image.load('background4.png')
...
while running:
    ...
    player1.x = max(0, min(player1.x, WIDTH // 2 - 250 - player1.width))
    player2.x = max(WIDTH // 2 + 250, min(player2.x, WIDTH - player2.width))
    ...
    winner = ''
    win_score = 15
    if score_player1 >= 14 and score_player2 >= 14:  
        win_score += 1
